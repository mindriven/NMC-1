...
async function create<T>(dir: string, file: string, data: Object | Array<T> | string) {
...
async function update<T>(dir: string, file: string, data: Object | Array<T> | string) {
...
async function createOrUpdate<T>(dir: string, file: string, data: Object | Array<T> | string) {
    try {
...
const dataFile = (dir: string, file: string) => dataDir(dir) + '/' + (file.includes('.') ? file : (file + '.json'));